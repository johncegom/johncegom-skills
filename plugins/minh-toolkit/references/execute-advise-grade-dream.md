...
**Advise is the third resort.** First *look it up*: if reading, running, or searching answers the question, Advise is not a substitute. Then *ask the user*: preferences and constraints only they know go to them — an advisor answering those confidently is worse than no answer. Advise gets what's left: a delegated judgment call that research can't settle.
