...
![version](https://img.shields.io/badge/version-0.7.2-blue) ![license](https://img.shields.io/badge/license-MIT-lightgrey) ![skills](https://img.shields.io/badge/skills-10-informational)
...
**Do I need to enable each skill individually?** No — installing the plugin enables all of them. Nine trigger automatically from what you say; `socratic-brainstorm` is the one exception and only runs when you explicitly ask for it.
